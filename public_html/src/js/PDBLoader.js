...
"lr": [199, 0, 102], "rf": [204, 0, 89], "db": [209, 0, 79], "sg": [217, 0, 69],
"bh": [224, 0, 56], "hs": [230, 0, 46], "mt": [235, 0, 38],
"ds": [235, 0, 38], "rg": [235, 0, 38], "cn": [235, 0, 38], 
"uut": [235, 0, 38], "uuq": [235, 0, 38], "uup": [235, 0, 38], 
"uuh": [235, 0, 38], "uus": [235, 0, 38], "uuo": [235, 0, 38]};
    ...
    parsePDB: function(text) {
        ...
        for (var i = 0, il = lines.length; i < il; ++i) {
            ...
            if (lines[i].substr(0, 4) === "ATOM" || lines[i].substr(0, 6) === "HETATM") {
                ...
                atoms.push([x, y, z, PDBLoader.atomColors[e], PDBLoader.atomRadii[e], capitalize(e)]);
    ...
    createModel: function(json) {
            ...
            ( atoms, atomScale, quality, model )
        {
            ...
            for (var i = 0; i < atoms.length; i++) 
            {
                ...
                //create the atom
                var atomMaterial = new THREE.MeshLambertMaterial( { color: color.getHex ( ) });
