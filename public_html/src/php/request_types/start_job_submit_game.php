<?php
	...
	function handle_start_job_submit_game_request($request_object){
		...
		$response_object['quota']['total'] = "12";
		$response_object['quota']['remaining'] =  "13";

		$response_object['proteins'] = get_protein_list();
		$response_object['ligands'] = get_ligands($NUM_START_LIGANDS);
	...
	function get_ligands($num_comfirmations){
		...
		foreach( $categories as $id => $category ){
			...
			$new_ligand["conformations"] = $category;
